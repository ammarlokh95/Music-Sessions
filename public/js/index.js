...
function (_React$Component) {
  ...
  function MainApp(props) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(MainApp).call(this, props));
  }
  ...
  _createClass(MainApp, [{
    ...
    value: function componentDidMount() {
      ...
      window.onSpotifyWebPlaybackSDKReady = function () {
        var _window = window,
            access_token = _window.access_token;
        var _window2 = window,
            interval = _window2.interval;
        ...
        var intervalFunction = function intervalFunction() {
          ...
          fetch('/login/refresh').then(function (res) {
            return res.json();
          }).then(function (data) {
            console.log(data);
            access_token = data.access_token;
            interval = data.interval;
            player.getOAuthToken(access_token);
        ...
        setTimeout(intervalFunction, interval); // Error handling
        ...
        player.addListener('player_state_changed', function (state) {}); // Ready
    ...
    value: function render() {
      return _react.default.createElement("div", {
        className: "MainApp"
      }, _react.default.createElement("button", null, "Host"), _react.default.createElement("button", null, "Join"));
    }
  }]);

  return MainApp;
}(_react.default.Component); // render the app


(0, _reactDom.render)(_react.default.createElement(MainApp, null), document.getElementById('app'));
